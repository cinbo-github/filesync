...
public class TestMainClass {
    ...
    public static String srcFilePath="d:\\tmp\\lorem2.txt";
    public static String destFilePath="d:\\tmp\\lorem1.txt";

    public static String afterSyncFile = "d:\\tmp\\aftersync1.data";
    public static String syncDataFile = "d:\\tmp\\rsync1.data";
